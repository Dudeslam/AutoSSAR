...
int main (int argc, char** argv){
    ...
    //Pub Subs
    ros::Subscriber map_sub = nh.subscribe("/pcl_render_node/local_map", 1, getMapCallback);
    ros::Subscriber map_sub2 = nh.subscribe("/map_generator/global_cloud", 1, getMapCallback);
