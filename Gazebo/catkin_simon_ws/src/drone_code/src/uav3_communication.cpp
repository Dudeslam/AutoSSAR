...
#include "drone_code/coordination.h"
...
{
    ros::init(argc, argv, "uav3_communication");
    ros::NodeHandle nh;
	...
	ros::Subscriber receivedFrontiers2_sub = nh.subscribe<drone_code::coord>
    ("/uav1/frontierGoal", 1, ReceivedFrontierCallback);
	ros::Subscriber receivedFrontiers3_sub = nh.subscribe<drone_code::coord>
    ("/uav2/frontierGoal", 1, ReceivedFrontierCallback);
