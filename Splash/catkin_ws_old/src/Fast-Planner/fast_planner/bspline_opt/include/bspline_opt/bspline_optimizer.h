...
public:
  ...
  //extend for coordination
  static const int COORDINATION;
  static const int GUIDE_COORD_PHASE;
  static const int NORMAL_COORD_PHASE;
  ...
  //plan_data_.coord_waypoints_
  void setCoordPath(const vector<Eigen::Vector3d>& coord_pt);
...
private:
  ...
  vector<Eigen::Vector3d> coord_pt_;   // waypts for multi-uav coordination
                                       //
  ...
  vector<Eigen::Vector3d> g_coord_;
  ...
  void calcCoordCost(const vector<Eigen::Vector3d>& q, double& cost, vector<Eigen::Vector3d>& gradient);
